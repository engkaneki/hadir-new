            ...
            <div class="card">
                <div class="row g-0">
                    <div class="col d-flex flex-column">
                        <form action="{{ url('parrent/profil/update') }}" method="post">
                            @csrf
                            <div class="card-body">
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ url('parrent/profil/updatefoto') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3">
    ...
    <div class="modal modal-blur fade" id="modal-password" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ url('parrent/profil/updatepassword') }}" method="post">
                        @csrf
                        <div class="mb-3">
