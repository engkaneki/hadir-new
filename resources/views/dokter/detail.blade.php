        ...
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                <div class="col">
                    ...
                    <h2 class="page-title">
                        Detail Pengajuan Dokter KK atas nama {{ $berkas->nama_anak }}
                    </h2>
                </div>
            </div>
        </div>
                            ...
                            {{-- <div class="col-6 mb-3">
                                ...
                                @else
                                    <a data-fslightbox="gallery"
                                        href="{{ url('http://dokter.disdukcapil.batubarakab.go.id/storage/uploads/aktalahir/' . $berkas->surat_pengantar) }}"
                                        target="_blank">
                                        <!-- Photo -->
                                        <div class="img-responsive img-responsive-3x1 rounded-3 border"
                                            style="background-image: url({{ url('http://dokter.disdukcapil.batubarakab.go.id/storage/uploads/aktalahir/' . $berkas->surat_pengantar) }})">
                                        </div>
                                    </a>
                                    <button class="btn btn-success mt-3"
                                        onclick="printFile('{{ url('http://dokter.disdukcapil.batubarakab.go.id/storage/uploads/aktalahir/' . $berkas->surat_pengantar) }}')">Cetak</button>
                                @endif
                            </div> --}}
                            <div class="col-6 mb-3">
                                ...
                                @else
                                    <a data-fslightbox="gallery"
                                        href="{{ url('http://dokter.disdukcapil.batubarakab.go.id/storage/uploads/aktalahir/' . $berkas->surat_lahir) }}"
                                        target="_blank">
                                        <!-- Photo -->
                                        <div class="img-responsive img-responsive-3x1 rounded-3 border"
                                            style="background-image: url({{ url('http://dokter.disdukcapil.batubarakab.go.id/storage/uploads/aktalahir/' . $berkas->surat_lahir) }})">
                                        </div>
                                    </a>
                                    <button class="btn btn-success mt-3"
                                        onclick="printFile('{{ url('http://dokter.disdukcapil.batubarakab.go.id/storage/uploads/aktalahir/' . $berkas->surat_lahir) }}')">Cetak</button>
                                @endif
                            </div>
                            <div class="col-6 mb-3">
                                ...
                                @else
                                    <a data-fslightbox="gallery"
                                        href="{{ url('http://dokter.disdukcapil.batubarakab.go.id/storage/uploads/aktalahir/' . $berkas->kk) }}"
                                        target="_blank">
                                        <!-- Photo -->
                                        <div class="img-responsive img-responsive-3x1 rounded-3 border"
                                            style="background-image: url({{ url('http://dokter.disdukcapil.batubarakab.go.id/storage/uploads/aktalahir/' . $berkas->kk) }})">
                                        </div>
                                    </a>
                                    <button class="btn btn-success mt-3"
                                        onclick="printFile('{{ url('http://dokter.disdukcapil.batubarakab.go.id/storage/uploads/aktalahir/' . $berkas->kk) }}')">Cetak</button>
                                @endif
                            </div>
                            <div class="col-6 mb-3">
                                ...
                                @else
                                    <a data-fslightbox="gallery"
                                        href="{{ url('http://dokter.disdukcapil.batubarakab.go.id/storage/uploads/aktalahir/' . $berkas->ktp_ayah) }}"
                                        target="_blank">
                                        <!-- Photo -->
                                        <div class="img-responsive img-responsive-3x1 rounded-3 border"
                                            style="background-image: url({{ url('http://dokter.disdukcapil.batubarakab.go.id/storage/uploads/aktalahir/' . $berkas->ktp_ayah) }})">
                                        </div>
                                    </a>
                                    <button class="btn btn-success mt-3"
                                        onclick="printFile('{{ url('http://dokter.disdukcapil.batubarakab.go.id/storage/uploads/aktalahir/' . $berkas->ktp_ayah) }}')">Cetak</button>
                                @endif
                            </div>
                            <div class="col-6 mb-3">
                                ...
                                @else
                                    <a data-fslightbox="gallery"
                                        href="{{ url('http://dokter.disdukcapil.batubarakab.go.id/storage/uploads/aktalahir/' . $berkas->ktp_ibu) }}"
                                        target="_blank">
                                        <!-- Photo -->
                                        <div class="img-responsive img-responsive-3x1 rounded-3 border"
                                            style="background-image: url({{ url('http://dokter.disdukcapil.batubarakab.go.id/storage/uploads/aktalahir/' . $berkas->ktp_ibu) }})">
                                        </div>
                                    </a>
                                    <button class="btn btn-success mt-3"
                                        onclick="printFile('{{ url('http://dokter.disdukcapil.batubarakab.go.id/storage/uploads/aktalahir/' . $berkas->ktp_ibu) }}')">Cetak</button>
                                @endif
                            </div>
                            <div class="col-6 mb-3">
                                ...
                                @else
                                    <a data-fslightbox="gallery"
                                        href="{{ url('http://dokter.disdukcapil.batubarakab.go.id/storage/uploads/aktalahir/' . $berkas->buku_nikah) }}"
                                        target="_blank">
                                        <!-- Photo -->
                                        <div class="img-responsive img-responsive-3x1 rounded-3 border"
                                            style="background-image: url({{ url('http://dokter.disdukcapil.batubarakab.go.id/storage/uploads/aktalahir/' . $berkas->buku_nikah) }})">
                                        </div>
                                    </a>
                                    <button class="btn btn-success mt-3"
                                        onclick="printFile('{{ url('http://dokter.disdukcapil.batubarakab.go.id/storage/uploads/aktalahir/' . $berkas->buku_nikah) }}')">Cetak</button>
                                @endif
                            </div>
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    @else
                                        <a data-fslightbox="gallery"
                                            href="{{ url('http://dokter.disdukcapil.batubarakab.go.id/storage/uploads/aktalahir/' . $berkas->lainnya) }}"
                                            target="_blank">
                                            <!-- Photo -->
                                            <div class="img-responsive img-responsive-3x1 rounded-3 border"
                                                style="background-image: url({{ url('http://dokter.disdukcapil.batubarakab.go.id/storage/uploads/aktalahir/' . $berkas->lainnya) }})">
                                            </div>
                                        </a>
                                        <button class="btn btn-success mt-3"
                                            onclick="printFile('{{ url('http://dokter.disdukcapil.batubarakab.go.id/storage/uploads/aktalahir/' . $berkas->lainnya) }}')">Cetak</button>
                                    @endif
                                </div>
                            </div>
                        </div>
