            ...
            <div class="row row-deck row-cards">
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div class="subheader">Pengajuan Dokter KK</div>
                            </div>
                            <div class="d-flex align-items-baseline mt-3">
                                <div class="h1 mb-3 me-2">{{ $dokter }} Berkas</div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-3">
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div class="subheader">Seluruh Pengajuan yang Masuk</div>
                            </div>
                            <div class="d-flex align-items-baseline mt-3">
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div class="subheader">Seluruh Pengajuan yang Selesai</div>
                            </div>
                            <div class="d-flex align-items-baseline mt-3">
                                <div class="h1 mb-3 me-2">{{ $selesai }} Berkas</div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-3">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-baseline mt-3">
                                <div class="h1 mb-3 me-2">{{ $belumantar }} Berkas</div>
                            </div>
                        </div>
                    </div>
                </div>
