                        ...
                        <form action="{{ url('profil/update') }}" method="post">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row align-items-center">
                                    @if ($profil && $profil->foto_operator)
                                        {{-- Jika ada foto_operator, tampilkan foto dari storage --}}
                                        <div class="col-auto">
                                            <span class="avatar avatar-xl"
                                                style="background-image: url('{{ asset('storage/avatars/' . $profil->foto_operator) }}')"></span>
                                        </div>
                                    @else
                                        {{-- Jika tidak ada foto_operator, tampilkan default --}}
                                        <div class="col-auto">
                                            <span class="avatar avatar-xl"
                                ...
                                <h3 class="card-title mt-4">Informasi Desa</h3>
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md">
                                        <div class="form-label">Alamat Kantor Desa</div>
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md">
                                            ...
                                            <input name="no_hp" type="number" name="no_hp" id=""
                                                class="form-control" value="{{ $profil->no_hp }}">
                                        </div>
                                        <div class="col-md">
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ url('profil/updatefoto') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3">
                            <label class="form-label">Upload Foto</label>
                            <input type="file" class="form-control" name="foto_operator">
                        </div>
